...
{	
	...
	public class GIFPlayer extends Bitmap
	{
		...
		/*	----------------------------------------新加clone方法，将GIFPlayer重复利用-------------------------------	*/
		/**
		 * 2014-5-30
		 * @param	decoder
		 */
		public function setGifDecoder( decoder:GIFDecoder ):void
		{
			gifDecoder = decoder;
		}
		
		public function setArrayLng( len:int ):void
		{
			arrayLng = len;
		}
		
		public function getArratLng():int
		{
			return arrayLng;
		}
		...
		{
			var p:GIFPlayer = new GIFPlayer( false );
			p._aFrames = this._aFrames;
			p.setGifDecoder( this.gifDecoder );
			p.setArrayLng( this.getArratLng() );
			return p;
		}
		...
		{
			if(aFrames[ 0 ].bitmapData)
				return aFrames[ 0 ].bitmapData.width;
			return 24;
		}
		...
		{
			if(aFrames[ 0 ].bitmapData)
				return aFrames[ 0 ].bitmapData.height;
			else return 24;
		}
		...
		*/
		...
		public function get _aFrames():Array 
		{
			return aFrames;
		}
		
		public function set _aFrames(value:Array):void 
		{
			aFrames = value;
		}
