package tetequ.live.modules.room.chat.privates.view 
{
	...
	public class PrivateMessagePanel extends Group
	{
		/**
		 * 垂直滑动条
		 */
		 ...
		 * 输入框
		 */
		private var _input:PrivateInputView;
		...
		public function PrivateMessagePanel(userData:User) 
		{
			super();
			_userData = userData;
			init();
		...
		private function init():void 
		{
			...
			addElement( _input = new PrivateInputView() );
			_input.input.userData = _userData;
			_input.bottom = 13;
		}
