package tetequ.live.modules.room.chat.privates.mediator 
{
	 ...
	 * @author Pandazhong
	 */
	public class PrivateInputMediator extends Mediator 
	{
		[Inject]
		public var view:PrivateInputView;
		...
		public function PrivateInputMediator() 
		{
			super();
		...
		private function createChatMessage( msg:String ):ChatMessageVo
		{
			...
			msgVo.toUser = view.input.userData;
			msgVo.userLevel = networkFacade.user.level;
			msgVo.from = networkFacade.user;
			return msgVo;
		}
