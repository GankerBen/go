package tetequ.live.modules.room.chat.input.view 
{
	 ...
	 * 群聊天输入框界面
	 */
	public class GroupChatInputView extends Group 
	{
		/**
		 * 表情按钮
		 */
		 ...
		 * 构造函数
		 */
		public function GroupChatInputView() 
		{
			super();
			initComponents();
		}
		...
		private function initComponents():void 
		{
			...
			_bg.graphics.drawRoundRect(0, 0, 150, 32, 5, 5);
			...
			this.height = 34;
			this.id = LayoutElementsID.GROUP_CHAT_INPUT;
		}
